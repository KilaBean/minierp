...
const testimonials = [
  ...
  { name: "James Mensah",   role: "Founder, TechHub Accra",  avatar: "JM", color: "from-sky-500 to-blue-600", rating: 5, text: "As a tech retailer, inventory was always my biggest headache. MiniERP's low-stock alerts and sales tracking have saved me countless hours. My team loves the POS system." },
